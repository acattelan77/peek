...
The master was generated with Codex's built-in image-generation mode. Keep the checked-in master so all derived assets remain reproducible.

## Status icon

The menu-bar mark is drawn by `scripts/generate-assets.swift`, not generated independently. This guarantees a monochrome alpha template with consistent geometry at 1x, 2x, and 3x.
